...
import { BookOpen, Clock, TrendingUp, Play, BookMarked, Award, Target } from "lucide-react";
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {[
              { icon: BookOpen, label: "Lessons Completed", value: "12", color: "bg-blue-500" },
              { icon: Clock, label: "Study Time", value: "24h", color: "bg-green-500" },
              { icon: TrendingUp, label: "Progress", value: "85%", color: "bg-purple-500" },
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              <Link href="/session">
                ...
                >
                  ...
                  <p className="text-white/80">Begin a personalized tutoring session</p>
                </motion.div>
              </Link>
              ...
              <Link href="/lessons">
                ...
                >
                  ...
                  <h3 className="text-xl font-semibold mb-2 text-gray-900">Browse Lessons</h3>
                  <p className="text-gray-600">Explore available subjects and topics</p>
                </motion.div>
              </Link>
          ...
          >
            ...
            <div className="space-y-4">
              {[
                { subject: "Mathematics", topic: "Algebra Basics", date: "2 hours ago", progress: 75 },
                { subject: "English", topic: "Grammar Review", date: "Yesterday", progress: 100 },
                { subject: "Physics", topic: "Mechanics", date: "2 days ago", progress: 50 },
              ].map((activity, index) => (
                <motion.div
                  key={index}
                ...
                >
                  <div className="flex-1">
                    ...
                    <div className="ml-13">
                      <div className="flex items-center justify-between text-sm mb-1">
                        ...
                        <span className="text-gray-900 font-medium">{activity.progress}%</span>
                      </div>
                  ...
                  <div className="text-sm text-gray-500 ml-4">{activity.date}</div>
                </motion.div>
              ))}
            </div>
          </motion.div>
