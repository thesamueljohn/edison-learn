...
const lessonData: Record<number, { name: string; lessons: Array<{ id: number; title: string; duration: string; completed: boolean }> }> = {
  1: {
    name: "Mathematics",
    lessons: [
  ...
  2: {
    ...
    lessons: [
      ...
      { id: 2, title: "Sentence Structure", duration: "16 min", completed: true },
